                        ...
                        <div class="p-5 flex-1 flex flex-col">
                            ...
                            <div class="flex flex-col gap-2 mt-4">
                                ...
                                <div class="grid grid-cols-2 gap-2">
                                    ...
                                    <a href="#"
                                        class="w-full flex items-center justify-center gap-1 px-3 py-2 bg-gray-900 dark:bg-white text-white dark:text-gray-900 text-xs font-bold rounded-xl hover:bg-indigo-600 dark:hover:bg-indigo-400 transition-all duration-200">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path
